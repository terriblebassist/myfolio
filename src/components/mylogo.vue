<template>
    <svg id="ekYqehd4HBs1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 646 646" shape-rendering="geometricPrecision" text-rendering="geometricPrecision">
        <defs>
            <radialGradient id="ekYqehd4HBs4-fill" cx="0" cy="0" r="1" spreadMethod="pad" gradientUnits="userSpaceOnUse" gradientTransform="matrix(-162.49900000000005 182.49999999999991 -228.86199999999982 -203.77900000000002 323 322)">
                <stop id="ekYqehd4HBs4-fill-0" offset="12.218600%" stop-color="rgb(214,173,96)" />
                <stop id="ekYqehd4HBs4-fill-1" offset="66.145800%" stop-color="rgba(255,255,255,0)" />
            </radialGradient>
        </defs>
        <circle id="ekYqehd4HBs2" r="322.500000" transform="matrix(1 0 0 1 323 323)" fill="rgb(18,38,32)" stroke="rgb(214,173,96)" stroke-width="1" />
        <path
            id="ekYqehd4HBs3"
            d="M330.585000,74.000100L634,399.855000L558.146000,399.855000L330.585000,166.807000L269.902000,229.193000L467.122000,430.790000L330.585000,570L133.366000,368.403000L103.024000,399.339000L12,399.339000L133.366000,275.597000L330.585000,477.193000L376.098000,430.790000L178.372000,229.193000L330.585000,74.000100Z"
            fill="rgb(182,141,64)"
            stroke="none"
            stroke-width="1"
        />
        ...
        mounted() {
            !(function (t, n) {
                "object" == typeof exports && "undefined" != typeof module
                    ...
                    ? define(n)
                    : ((t = "undefined" != typeof globalThis ? globalThis : t || self).__SVGATOR_PLAYER__ = n());
            })(this, function () {
                "use strict";
                function t(n) {
                    return (t =
                ...
                function A(t, n, r) {
                    return 0 === t ? n : 1 === t ? r : { r: k(t, n.r, r.r), g: k(t, n.g, r.g), b: k(t, n.b, r.b), a: b(t, null == n.a ? 1 : n.a, null == r.a ? 1 : r.a) };
                }
                function _(t, n, r) {
                    if (0 === t) return n;
                    if (1 === t) return r;
                    ...
                    return s
                        ? (function (t, n, r) {
                              ...
                              if (Array.isArray(n)) {
                                  ...
                                  return function (e) {
                                      var o = r(e);
                                      if (null == o) for (var u = 0; u < i; u++) t[u].removeAttribute(n);
                ...
                function z(t, n) {
                    ...
                    return r
                        ? (function (t, n) {
                          ...
                          })(r, n.duration, n.iterations || 1 / 0, n.direction || 1, !!n.alternate, n.fill || 1)
                        : null;
                }
                var L = (function () {
                    function t(r, e) {
                                ...
                                },
                                {
                                    ...
                                    value: function () {
                                        (!this._rollingBack && this._running) ||
                                            ((this._rollingBack = !1),
                                            this.rollbackStartOffset > this.duration && ((this.offset = this.rollbackStartOffset - ((this.rollbackStartOffset - this.offset) % this.duration)), (this.rollbackStartOffset = 0)),
                            ...
                            [
                                {
                                    ...
                                    value: function (n, r) {
                                        return (n = (function (t, n) {
                                            ...
                                            return o.length ? { element: e, animations: o, animationSettings: t.animationSettings, options: t.options || void 0 } : null;
                                        })(n, r))
                                            ? { el: n.element, options: n.options || {}, player: new t(n.animations, n.animationSettings, n.options) }
                                            : null;
                                    },
                                },
                            ]
                                ...
                                },
                                {
                                    ...
                                    value: function () {
                                        ...
                                        return (
                                            ...
                                            n && this.rotateSelf(n),
                                            r && (r.x && this.skewSelf(r.x, 0), r.y && this.skewSelf(0, r.y)),
                                ...
                                },
                                {
                                    ...
                                    value: function () {
                                        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0,
                                            ...
                                            o = nt(e);
                                        if (0 === o) return { origin: { x: r[4], y: r[5] }, translate: { x: t, y: n }, scale: { x: 0, y: 0 }, skew: { x: 0, y: 0 }, rotate: 0 };
                                        (i[0][0] /= o), (i[0][1] /= o);
                                        ...
                                        if (0 === l) return { origin: { x: r[4], y: r[5] }, translate: { x: t, y: n }, scale: { x: o, y: 0 }, skew: { x: 0, y: 0 }, rotate: 0 };
                                        (i[1][0] /= l), (i[1][1] /= l), (a /= l);
                                        var f = 0;
                                        return (
                                            i[1][1] < 0 ? ((f = Z(i[1][1]) * tt), i[0][1] < 0 && (f = 360 - f)) : (f = J(i[0][1]) * tt),
                                            u && (f = -f),
                                            (a = W(a, nt(i[0][0] * i[0][0] + i[0][1] * i[0][1])) * tt),
                                            u && (a = -a),
                                            { origin: { x: r[4], y: r[5] }, translate: { x: t, y: n }, scale: { x: o, y: l }, skew: { x: a, y: 0 }, rotate: f }
                                        );
                                    },
                                },
                                {
            ...
            __SVGATOR_PLAYER__.build({
                ...
                animations: [
                    {
                        ...
                        elements: {
                            ekYqehd4HBs3: {
                                transform: {
                                    data: { o: { x: 323, y: 322.0000534057617, type: "corner" }, t: { x: -323, y: -322.0000534057617 } },
                                    keys: {
                                        r: [
                                            { t: 500, v: 0, e: [0.39, 0.575, 0.565, 1] },
                                            { t: 1100, v: 90, e: [0.39, 0.575, 0.565, 1] },
                                            { t: 1500, v: 90, e: [0.39, 0.575, 0.565, 1] },
                                            { t: 2100, v: 180, e: [0.39, 0.575, 0.565, 1] },
                                            { t: 2500, v: 180, e: [0.39, 0.575, 0.565, 1] },
                                            { t: 3100, v: 270, e: [0.39, 0.575, 0.565, 1] },
                                            { t: 3500, v: 270, e: [0.39, 0.575, 0.565, 1] },
                                            { t: 4000, v: 360, e: [0, 0, 0.58, 1] },
                                        ],
                                    },
                                },
                            },
                ...
                options: { start: "load", hover: "freeze", click: "freeze", scroll: 25, font: "embed", exportedIds: "unique", svgFormat: "animated", title: "logo" },
                animationSettings: { duration: 5000, direction: 1, iterations: 0, fill: 1, alternate: false, speed: 1 },
            });
        },
    };
</script>

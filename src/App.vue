<template>
    <div>
        <header class="header bg-gray-800 shadow">
            <div class="container mx-auto px-6 py-4">
                <div class="flex items-center justify-between">
                    <div>
                        <a class="flex items-center text-white hover:text-lightgreen" href="#">
                            <MyLogoComponent class="h-6 w-6 sm:h-6 sm:w-6"></MyLogoComponent>
                            <span class="mx-3 font-medium text-sm md:text-base">Abhinav Singh</span>
                        </a>
                    </div>
                    <div class="flex items-center -mx-2">
                        <a class="flex items-center mx-2 text-white hover:text-lightgreen transition duration-500 ease-in-out transform hover:scale-110" href="https://github.com/terriblebassist/resume/releases/latest/download/CV_ABHINAV_SINGH.pdf" target="_blank" rel="noopener noreferrer">
                            <svg class="h-5 w-5 sm:h-6 sm:w-6 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill-rule="evenodd" clip-rule="evenodd">
                                <path
                            ...
                            <span class="px-2 text-white">Resume</span>
                        </a>
                    </div>
                </div>
            </div>
        ...
        <section class="bg-white mt-10 home">
            <div class="max-w-2xl px-6 text-center mx-auto py-8">
                <h2 class="text-5xl font-semibold text-gray-800">
                    Hi, I'm
                    <span class="bg-seagreen text-white rounded px-1 animate-pulse">Abhinav</span>
                </h2>
                <p class="text-gray-600 mt-4">Software Developer • Pianist • Bassist • Trekking Enthusiast</p>
                <span class="inline-flex my-4">
                    <a class="text-gray-500 hover:text-seagreen transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110" href="https://www.facebook.com/abhinavsingh20111996/" target="_blank" rel="noopener noreferrer">
                    ...
                    <a class="ml-4 text-gray-500 hover:text-seagreen transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110" href="https://www.linkedin.com/in/abhinavsingh1996/" target="_blank" rel="noopener noreferrer">
                        <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-6 h-6" viewBox="0 0 24 24">
                            <path
                    ...
                    <a class="ml-4 text-gray-500 hover:text-seagreen transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110" href="https://www.instagram.com/abhinav.singh96/" target="_blank" rel="noopener noreferrer">
                        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-6 h-6" viewBox="0 0 24 24">
                            <rect width="20" height="20" x="2" y="2" rx="5" ry="5"></rect>
                            <path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37zm1.5-4.87h.01"></path>
                        </svg>
                    </a>
                    <a class="ml-4 text-gray-500 hover:text-seagreen transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110" href="https://github.com/terriblebassist" target="_blank" rel="noopener noreferrer">
        ...
        <section class="bg-gray-800 pattern py-20 mt-20">
            <div class="max-w-5xl px-6 mx-auto text-center">
                <h2 class="text-2xl font-semibold text-lightgreen project-t">Projects</h2>
            ...
            <div class="container px-5 py-24 mx-auto">
                ...
                <div class="lg:w-1/2 md:w-2/3 mx-auto">
                    <form name="contact" method="POST" data-netlify="true" data-netlify-honeypot="bot-field" class="flex flex-wrap -m-2">
                        ...
                        <div class="p-2 w-full">
                            <button type="submit" class="flex mx-auto text-white bg-seagreen border-0 py-2 px-8 focus:outline-none hover:bg-gray-800 rounded text-lg transition duration-500 ease-in-out transform hover:scale-110">Send</button>
                        </div>
                    </form>
                    <div>
                        <div class="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                            <div class="p-2">
                                <a class="text-seagreen">asingh175@gmail.com</a>
                            </div>
...
<script>
    import MyLogoComponent from "./components/mylogo.vue";
